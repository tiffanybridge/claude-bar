...
// When a monthly budget is set (Enterprise-billed usage), shows spend vs budget.
// Without a budget (flat-rate Pro), shows raw token windows only.
struct LocalUsageView: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 8) {
            ...
            // Budget section — only shown when a monthly budget is configured
